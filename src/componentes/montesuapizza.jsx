...
const MonteSuaPizza = ({ modal, adicionarNoCarrinho, precoCarrinho, handleSizeClick }) => {
  ...
  const handleAddToCart = () => {
    adicionarNoCarrinho({ ...pizza, quantity: quantidade, image: './images/monte.jpg' });
    setQuantidade(1);
    modal();
  };
  ...
  return (
    <div className="modal">
      <div className="modal-content">
        <button onClick={modal} className="button-monte close">X</button>
        ...
        <div className="quantidade-carrinho">
          ...
          <button type="button" onClick={() => { abreModal(); precoConfirmado(); }} className="button-monte">Adicionar ao Carrinho</button>
        </div>
        ...
        <div className="modal2">
          <div className="modal-content2">
            ...
            <button onClick={() => {abreModal()}} className="button-monte">Cancelar</button>
            <button onClick={() => { handleAddToCart(); setPrecoReal(0); }} className="button-monte">Confirmar</button>
          </div>
        </div>
      )}
